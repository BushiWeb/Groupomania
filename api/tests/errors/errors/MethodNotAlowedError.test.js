import MethodNotAllowedMethod from '../../../src/errors/errors/MethodNotAllowedError.js';

describe('MethodNotAllowedMethod test suite', () => {
    ...
    describe('Constructor test suite', () => {
        it('should create an instance with the specified informations', () => {
            const error = new MethodNotAllowedMethod(errorInformations, origin, headers);

            expect(error).toHaveProperty('name', 'MethodNotAllowedError');
            ...
            expect(error).toHaveProperty('statusCode', 405);
        ...
        it('should create an instance with the default informations', () => {
            ...
            const error = new MethodNotAllowedMethod(lessErrorInformations);
