import MethodNotAllowedError from '../../../src/errors/errors/MethodNotAllowedError.js';

describe('MethodNotAllowedError test suite', () => {
    ...
    describe('Constructor test suite', () => {
        it('should create an instance with the specified informations', () => {
            const error = new MethodNotAllowedError(errorInformations, log, origin);
        ...
        it('should create an instance with the default informations', () => {
            ...
            const error = new MethodNotAllowedError(lessErrorInformations);
