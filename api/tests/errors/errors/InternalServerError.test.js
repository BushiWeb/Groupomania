import InternalServerError from '../../../src/errors/errors/InternalServerError.js';

describe('InternalServerError test suite', () => {
    ...
    describe('Constructor test suite', () => {
        it('should create an instance with the specified informations', () => {
            const error = new InternalServerError(errorInformations, origin, headers);
        ...
        it('should create an instance with the default informations', () => {
            ...
            const error = new InternalServerError(lessErrorInformations);
