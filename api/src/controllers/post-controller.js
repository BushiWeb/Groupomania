 ...
 * Post fetching.
 * Calls the right service.
 * Sends a message to the client with status 200 containing the post informations, or calls the error handler
 *  middleware if an error occurs.
 ...
 * Sends a response with status 200 and the new post data to the client if the request is successful, or calls the
 *  error handler middleware if an error occurs.
 * @param {Express.Request} req - Express request object.
 * @param {Express.Response} res - Express response object.
 * @param next - Next middleware to execute.
 */
