        ...
        <div className={style.container}>
            <main className={style.error}>
                <h1 className={style.heading}>
                    Une situation inattendue s'est produite.
                </h1>
                <p className={style.message}>
                    Nous rencontrons quelques problèmes en tentant d'accéder à
                    votre requête.
                </p>
                <details className={style.moreInfo}>
                    ...
                    <ul>
                        <li>
                            Le traitement de votre requête a retourné une erreur
                            imprévue;
                        </li>
                        <li>
                            Le serveur peut être hors ligne ou bien rencontrer
                ...
                <div className={style.ctaWrapper}>
                    ...
                    <div className={style.ctaMessage}>
                        ...
                        <ol className={style.actionList}>
                            ...
                            <li>
                                Si votre connexion est bonne, alors réessayez
                                après avoir rafraîchi la page;
                            </li>
                            <li>
                                Si tous vos essais sont vains, alors essayer de
                                vous rapprocher des développeurs.
                            </li>
                        </ol>
                    </div>
                    <InteractiveElement
                    ...
                    <Link to="/" className={style.alternativeAction}>
